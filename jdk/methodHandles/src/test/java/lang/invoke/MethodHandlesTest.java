...
//            return wrap.wrap(nextArg++);
    ...
    static final Lookup PRIV_SUBCLASS = SubExample.lookup();
    ...
    public void testFindPrivate() throws Throwable {
        testGetter(false,PRIV_SUBCLASS,new Object[]{false,Example.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testGetter(false,PRIV_SUBCLASS,new Object[]{false,SubExample.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testSetter(false,PRIV_SUBCLASS,new Object[]{false,Example.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testSetter(false,PRIV_SUBCLASS,new Object[]{false,SubExample.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testGetter(false,PRIV_SUBCLASS,new Object[]{true,Example.class,"pri_sf0",int.class},null,TEST_FIND_STATIC);
        testGetter(false,PRIV_SUBCLASS,new Object[]{true,SubExample.class,"pri_sf0",int.class},null,TEST_FIND_STATIC);
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	PRIV_SUBCLASS.findStatic(Example.class, "pri_s0",MethodType.methodType(void.class));
        }}); 
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	PRIV_SUBCLASS.findStatic(SubExample.class, "pri_s0",MethodType.methodType(void.class));
        }});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	PRIV_SUBCLASS.findConstructor(Example.class, MethodType.methodType(void.class, boolean.class));
        }});
        checkNoSuchMethodException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	PRIV_SUBCLASS.findConstructor(SubExample.class, MethodType.methodType(void.class, boolean.class));
        }});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	PRIV_SUBCLASS.findVirtual(Example.class, "pri_v0",MethodType.methodType(void.class));
        }});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
