...
//            return wrap.wrap(nextArg++);
    ...
    // This lookup is good for checking checking protedtec-access
    static final Lookup SUBCLASS = SubExample.lookup();

    // Subject methods...
    static class Example implements IntExample {
    	private int pri_f0;
    	private static int pri_sf0;
		...
		private Example(boolean b) { this(); called("private <init>", this, b);}
    ...
    @Test 
    public void testFindPrivate() throws Throwable {
        testGetter(false,SUBCLASS,new Object[]{false,Example.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testGetter(false,SUBCLASS,new Object[]{false,SubExample.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testSetter(false,SUBCLASS,new Object[]{false,Example.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testSetter(false,SUBCLASS,new Object[]{false,SubExample.class,"pri_f0",int.class},null,TEST_FIND_FIELD);
        testGetter(false,SUBCLASS,new Object[]{true,Example.class,"pri_sf0",int.class},null,TEST_FIND_STATIC);
        testGetter(false,SUBCLASS,new Object[]{true,SubExample.class,"pri_sf0",int.class},null,TEST_FIND_STATIC);
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	SUBCLASS.findStatic(Example.class, "pri_s0",MethodType.methodType(void.class));
		}});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	SUBCLASS.findStatic(SubExample.class, "pri_s0",MethodType.methodType(void.class));
		}});
    	checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
    		SUBCLASS.findConstructor(Example.class, MethodType.methodType(void.class, boolean.class));
		}});
    	checkNoSuchMethodException(new CTROE(){ public void run() throws ReflectiveOperationException{
    		SUBCLASS.findConstructor(SubExample.class, MethodType.methodType(void.class, boolean.class));
		}});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
    		SUBCLASS.findVirtual(Example.class, "pri_v0",MethodType.methodType(void.class));
		}});
        checkIllegalAccessException(new CTROE(){ public void run() throws ReflectiveOperationException{
        	SUBCLASS.findVirtual(SubExample.class, "pri_v0",MethodType.methodType(void.class));
		}});
    }
    // CanThrowReflectiveOperationException
    public interface CTROE {
    	public void run() throws ReflectiveOperationException;
    }
    
    public void checkIllegalAccessException(CTROE check) {
    	checkException(check, IllegalAccessException.class);
    }
    public void checkNoSuchMethodException(CTROE check) {
    	checkException(check, NoSuchMethodException.class);
    }
    public void checkException(CTROE check,Class<? extends ReflectiveOperationException> expected) {
    	try {
    		check.run();
    		Assert.fail(expected + " not thrown.");
    	} catch (ReflectiveOperationException e) {
    		if (!expected.isAssignableFrom(e.getClass())) {
    			e.printStackTrace();
    			Assert.fail(expected + " not thrown. Instead: " + e.getClass());
    		}
		}
    }
